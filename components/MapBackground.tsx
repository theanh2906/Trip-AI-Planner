...
const MapBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 z-0 bg-[#e5e7eb] overflow-hidden pointer-events-none select-none">
       ...
       <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 1000 800" preserveAspectRatio="xMidYMid slice">
          <path d="M 200 800 Q 400 400 800 100" fill="none" stroke="#94a3b8" strokeWidth="4" strokeDasharray="10 5" className="opacity-40" />
          <path d="M 150 800 Q 300 500 600 50" fill="none" stroke="#64748b" strokeWidth="3" strokeDasharray="8 8" className="opacity-20" />
